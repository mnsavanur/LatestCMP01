...
public class Regression_Scenario_CP_09
    ...
    public void Regression_Scenario_CP_09_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_09";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theLocationsPage().theUser_().CPCoverages(testDataAsMap,"Regression_Scenario_CP_09_Transaction_01_NBQUNBIS");
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
            whileViewing().theRatingPage().theUser_().rateValidationMonoline();
            whileViewing().theIssuingInfo().theUser_().CPfillIssuingInfoDetails(testDataAsMap, sanNumber, "NBQUNBIS");
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_09_Transaction_01_NBQUNBIS" )
    public void Regression_Scenario_CP_09_Transaction_02_PCNM() throws Exception {
        excelFileName = "Regression_Scenario_CP_09";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
            whileViewing().theIssuingInfo().theUser_().CPfillIssuingInfoDetails(testDataAsMap, sanNumber, "NBIS");
            whileViewing().theBillingPage().theUser_().fillBillingPageDetails(testDataAsMap);
            whileViewing().theMiscInformationPage().theUser_().fillMiscInformation(testDataAsMap, sanNumber);
            whileViewing().thePolicyFormsPage().theUser_().fillsInPolicyForms2(testDataAsMap);
            whileViewing().theIssuePage().theUser_().issuePolicy();
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_09_Transaction_02_PCNM" )
    public void Regression_Scenario_CP_09_Transaction_03_DNRE() throws Exception {
        excelFileName = "Regression_Scenario_CP_09";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        testDataAsMap = utils.excelFileUtil().getExcelDataAsMapWithMultipleValues(excelFilePath, "DNRE");
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            whileViewing().theCMPLoginPage().theUser_().StartRecording(testDataAsMap.get("TestCase_ID").get(0));
            whileViewing().theCMPLoginPage().theUser_().logsIntoPolicyDecisions(utils.configReader().getURL(), testDataAsMap.get("userNameTxt").get(0), testDataAsMap.get("passwordTxt").get(0));
            whileViewing().theCMPHomePage().theUser_().performActionsOnPolicy(testDataAsMap, "DNRE", sanNumber);
            whileViewing().theTransactionInformationPage().theUser_().enterEstablishNonRenewalDetails(testDataAsMap);
            sanNumber = whileViewing().theCommonInfoPage().theUser_().fetchSan();
            whileViewing().theIssuePage().theUser_().issuePolicy();
            whileViewing().theCMPHomePage().theUser_().checkTransactionStatus(sanNumber);
            whileViewing().theCMPLoginPage().theUser_().logOut();
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_09_Transaction_03_DNRE" )
    public void Regression_Scenario_CP_09_Transaction_04_RDNR() throws Exception {
        excelFileName = "Regression_Scenario_CP_09";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        testDataAsMap = utils.excelFileUtil().getExcelDataAsMapWithMultipleValues(excelFilePath, "RDNR");
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            whileViewing().theCMPLoginPage().theUser_().StartRecording(testDataAsMap.get("TestCase_ID").get(0));
            whileViewing().theCMPLoginPage().theUser_().logsIntoPolicyDecisions(utils.configReader().getURL(), testDataAsMap.get("userNameTxt").get(0), testDataAsMap.get("passwordTxt").get(0));
            whileViewing().theCMPHomePage().theUser_().performActionsOnPolicy(testDataAsMap, "RDNR", sanNumber);
            sanNumber = whileViewing().theCommonInfoPage().theUser_().fetchSan();
            whileViewing().theIssuePage().theUser_().issuePolicy();
            whileViewing().theCMPHomePage().theUser_().checkTransactionStatus(sanNumber);
            whileViewing().theCMPLoginPage().theUser_().logOut();
