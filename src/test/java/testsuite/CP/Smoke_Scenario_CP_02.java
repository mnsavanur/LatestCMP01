        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Smoke_Scenario_CP_02_Transaction_01_NBIS() throws Exception {
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theLocationsPage().theUser_().CPCoverages(testDataAsMap,"Smoke_Scenario_CP_02_NBIS");
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Smoke_Scenario_CP_02_Transaction_01_NBIS")
    public void Smoke_Scenario_CP_02_Transaction_02_CANC() throws Exception {
        excelFileName = "Smoke_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    public void Smoke_Scenario_CP_02_Transaction_03_CARS() throws Exception {
        excelFileName = "Smoke_Scenario_CP_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
