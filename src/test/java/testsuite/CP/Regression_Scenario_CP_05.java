...
public class Regression_Scenario_CP_05
    ...
    public void Regression_Scenario_CP_05_Transaction_01_NBQUNBIS() throws Exception {
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theLocationsPage().theUser_().CPCoverages(testDataAsMap,"Regression_Scenario_CP_05_Transaction_01_NBQUNBIS");
    ...
    public void Regression_Scenario_CP_05_Transaction_02_PCNM() throws Exception {
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            sanNumber = whileViewing().theCommonInfoPage().theUser_().fetchSan();
            whileViewing().thePropertyPage().theUser_().enterPropertyPolicyInfo(testDataAsMap);
            whileViewing().theLocationsPage().theUser_().CPCoveragesDeletePCNM(testDataAsMap);
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
