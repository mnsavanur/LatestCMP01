...
public class Regression_Scenario_CP_08
    ...
    public void Regression_Scenario_CP_08_Transaction_01_NBQUNBIS() throws Exception {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CP_08";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theLocationsPage().theUser_().CPCoverages(testDataAsMap,"Regression_Scenario_CP_08_Transaction_01_NBQUNBIS");
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CP_08_Transaction_01_NBQUNBIS" )
    public void Regression_Scenario_CP_08_Transaction_02_DNRE() throws Exception {
        excelFileName = "Regression_Scenario_CP_08";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
