...
public class Regression_Scenario_CAP_06
    ...
    public void Regression_Scenario_CAP_06_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_06_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_06");
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CAP_06_Transaction_001_NBQUNBIS" )
    public void Regression_Scenario_CAP_06_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_06_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_CAP_06_Transaction_002_PCNM")
    public void Regression_Scenario_CAP_06_Transaction_03_PCNT() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_06_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
