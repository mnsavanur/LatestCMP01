...
public class Regression_Scenario_CAP_02
    ...
    public void Regression_Scenario_CAP_02_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_02_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            //whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_06");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_02");
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CAP_02_Transaction_001_NBQUNBIS")
    public void Regression_Scenario_CAP_02_Transaction_02_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_02_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_CAP_02_Transaction_02_CANC")
    public void Regression_Scenario_CAP_02_Transaction_03_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_02_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        ...
        {
            whileViewing().theCMPLoginPage().theUser_().logsIntoPolicyDecisions(utils.configReader().getURL(), testDataAsMap.get("userNameTxt").get(0), testDataAsMap.get("passwordTxt").get(0));
            whileViewing().theCMPHomePage().theUser_().performActionsOnPolicy(testDataAsMap,"CARS",sanNumber);
