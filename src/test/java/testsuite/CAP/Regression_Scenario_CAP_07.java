...
public class Regression_Scenario_CAP_07
    ...
    public void Regression_Scenario_CAP_07_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_07_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_07");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_07");
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CAP_07_Transaction_001_NBQUNBIS" )
    public void Regression_Scenario_CAP_07_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_07_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_CAP_07_Transaction_002_PCNM")
    public void Regression_Scenario_CAP_07_Transaction_03_PCNT() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_07_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 3 , dependsOnMethods = "Regression_Scenario_CAP_07_Transaction_03_PCNT")
    public void Regression_Scenario_CAP_07_Transaction_04_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_07_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 4 , dependsOnMethods = "Regression_Scenario_CAP_07_Transaction_04_CANC")
    public void Regression_Scenario_CAP_07_Transaction_05_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_07_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
