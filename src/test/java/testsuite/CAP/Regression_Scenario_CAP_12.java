...
public class Regression_Scenario_CAP_12
    ...
    public void Regression_Scenario_CAP_12_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_12_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_12");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap, "Regression_Scenario_CAP_12");
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CAP_12_Transaction_001_NBQUNBIS")
    public void Regression_Scenario_CAP_12_Transaction_002_CIRT() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_12_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theIssuingInfo().theUser_().CIRT_fillIssuingInfoDetails(testDataAsMap, sanNumber, "CIRT");
            whileViewing().theBillingPage().theUser_().fillBillingPageDetails(testDataAsMap);
            whileViewing().theMiscInformationPage().theUser_().fillMiscInformation(testDataAsMap, sanNumber);
           /* whileViewing().theIssuingInfo().theUser_().convertToIssue();
            ...
            whileViewing().theIssuePage().theUser_().issuePolicy();
            whileViewing().theCMPHomePage().theUser_().checkTransactionStatus(sanNumber);
            //whileViewing().theCMPLoginPage().theUser_()
            whileViewing().theCMPHomePage().theUser_().PerformVirtualPolicyDetails();
            whileViewing().theCMPLoginPage().theUser_().logOut();
