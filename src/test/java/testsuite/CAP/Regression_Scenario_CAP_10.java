...
public class Regression_Scenario_CAP_10
    ...
    public void Regression_Scenario_CAP_10_Transaction_001_NBQU() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQU";
        excelFileName = "Regression_Scenario_CAP_10_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            //whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_01");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_10");
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_CAP_10_Transaction_001_NBQU" )
    public void Regression_Scenario_CAP_10_Transaction_002_DECLINE() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_10_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
