...
public class Regression_Scenario_CAP_13
    ...
    public void Regression_Scenario_CAP_13_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        initialTransactionName = "NBQUNBIS";
        excelFileName = "Regression_Scenario_CAP_13_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_13");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_13");
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_CAP_13_Transaction_001_NBQUNBIS")
    public void Regression_Scenario_CAP_13_Transaction_002_CRTC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "Regression_Scenario_CAP_13_Test_Datafile";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
