...
public class Regression_Scenario_CAP_18
    ...
    public void Regression_Scenario_CAP_18_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_18");
            ...
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_18");
    ...
    public void Regression_Scenario_CAP_18_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theUnderwriterPage().theUser_().enterUnderwriterDetails(testDataAsMap);
            whileViewing().theCapitalAssetPage().theUser_().enterCapitalAssetPolicyDetail(testDataAsMap);
            whileViewing().theCapitalAssetPage().theUser_().addOptionalCovgs(testDataAsMap,"Regression_Scenario_CAP_18_PCNM");
            whileViewing().theCAPLocationPage().theUser_().PCNM_LocationCovgs(testDataAsMap,"Regression_Scenario_CAP_18_PCNM");
            whileViewing().theCAPLocationPage().theUser_().addLocationCovgs(testDataAsMap,"Regression_Scenario_CAP_18_PCNM");
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
