...
public class Smoke_Scenario_AgCAP_003
    ...
    public void Smoke_Scenario_CAP_03_Transaction_001_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        ...
        excelFileName = "Smoke_Scenario_AgCAP_03_Test_Datafile";
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theAgCAPLocationPage().theUser_().addLocations(testDataAsMap);
            whileViewing().theAgCAPLocationPage().theUser_().addLocationInfo(testDataAsMap);
            whileViewing().theAgCAPLocationPage().theUser_().addCoverage(testDataAsMap);
