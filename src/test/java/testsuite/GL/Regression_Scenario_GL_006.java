...
public class Regression_Scenario_GL_006
    ...
    public void Regression_Scenario_Transaction_006_NBQU() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBQU";
        excelFileName = "GL_Regression_06";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_Transaction_006_NBQU" )
    public void Regression_Scenario_Transaction_006_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_06";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2, dependsOnMethods = "Regression_Scenario_Transaction_006_PCNM")
    public void Regression_Scenario_Transaction_006_PCNT() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_06";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
