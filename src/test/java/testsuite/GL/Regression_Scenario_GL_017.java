...
public class Regression_Scenario_GL_017
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void  Regression_Scenario_GL_017_Transaction_001_NBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBIS";
        excelFileName = "GL_Regression_17";
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_GL_017_Transaction_001_NBIS" )
    public void Regression_Scenario_GL_017_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_17";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
...
/*
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_GL_017_Transaction_001_NBIS")
    public void Regression_Scenario_GL_017_Transaction_002_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_17";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_GL_017_Transaction_002_CANC")
    public void Regression_Scenario_GL_017_Transaction_003_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_17";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
