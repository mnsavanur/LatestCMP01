...
public class Regression_Scenario_GL_005
    ...
    public void Regression_Scenario_Transaction_005_NBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBIS";
        excelFileName = "GL_Regression_05";
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theClassCodePage().theUser_().addLocations2AndClassCode2(testDataAsMap);
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
            whileViewing().theCommonInfoPage().theUser_().checkStatus();
    ...
    @Test(enabled = true,  priority = 1, dependsOnMethods = "Regression_Scenario_Transaction_005_NBIS" )
    public void Regression_Scenario_Transaction_002_PCNM() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_05";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
