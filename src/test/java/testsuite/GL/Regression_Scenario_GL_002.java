...
public class Regression_Scenario_GL_002
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_Transaction_002_NBQU() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBQU";
        excelFileName = "GL_Regression_02";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_Transaction_002_NBQU")
    public void Regression_Scenario_Transaction_002_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_Transaction_002_CANC")
    public void Regression_Scenario_Transaction_002_CARS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_02";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
