...
public class Regression_Scenario_GL_022
        ...
        implements CMPLogin_Page.ILogin, CMPHome_Page.IHome, CommonInfo_Page.ICommonInfo, Names_Page.INames, Rating_Page.IRating, Issue_Page.IIssue_Page, IssuingInfo_Page.IIssuingInfo, PolicyForms_Page.IPolicyForms, FEIN_Page.IFEIN
{
    ...
    public void Regression_Scenario_Transaction_022_NBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBIS";
        excelFileName = "GL_Regression_22";
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_Transaction_022_NBIS")
    public void Regression_Scenario_Transaction_022_MANUOFF() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_22";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    @Test(enabled = true, priority = 2 , dependsOnMethods = "Regression_Scenario_Transaction_022_MANUOFF")
    public void Regression_Scenario_Transaction_022_MANUON() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_22";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
    ...
    /*
    @Test(enabled = true, priority = 3 , dependsOnMethods = "Regression_Scenario_Transaction_022_MANUON")
    public void Regression_Scenario_Transaction_022_CANC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_22";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
