...
public class Regression_Scenario_GL_013
    ...
    public void Regression_Scenario_GL_013_Transaction_001_NBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        initialTransactionName = "NBIS";
        excelFileName = "GL_Regression_13";
        ...
        if(testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail"))
        {
            ...
            whileViewing().theRatingPage().theUser_().Gen_Liab_Composite(testDataAsMap);
            whileViewing().theRatingPage().theUser_().ratePolicyWithoutVerification(testDataAsMap);
    ...
    @Test(enabled = true, priority = 1 , dependsOnMethods = "Regression_Scenario_GL_013_Transaction_001_NBIS")
    public void Regression_Scenario_GL_013_Transaction_002_CRTC() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException
    {
        excelFileName = "GL_Regression_13";
        excelFilePath = utils.configReader().getExcelFilePath(excelFileName);
