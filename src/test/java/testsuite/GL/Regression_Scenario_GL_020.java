...
public class Regression_Scenario_GL_020
    ...
    public void Regression_Scenario_Transaction_020_NBQUNBIS() throws IOException, InvalidFormatException, ParserConfigurationException, SAXException, InterruptedException {
        ...
        if (testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("$$NA$$") || testDataAsMap.get("Transaction_Status").get(0).equalsIgnoreCase("Fail")) {
            ...
            whileViewing().theLocationsPage().theUser_().GLCPCoverages(testDataAsMap,"Regression_Scenario_GL_CP_20_NBQU");
    ...
    @Test(enabled = true, priority = 1, dependsOnMethods = "Regression_Scenario_Transaction_020_NBQUNBIS")
