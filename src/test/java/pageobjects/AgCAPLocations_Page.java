 ...
 */
public class AgCAPLocations_Page extends TestFramework_Initializer {

    private Base_Util baseUtil;
    private Browser_Util browserUtil;
    private LogAndReport_Util log;
    private Screenshot_Util ss;
    private AgCAPLocations_Page.AgCAPLocationsMethods pageMethods;
    private String parent;

    public AgCAPLocations_Page(LogAndReport_Util logAndReport, Screenshot_Util screenshot, Browser_Util browser_Util, Base_Util base_util) {
        this.browserUtil = browser_Util;
        this.baseUtil = base_util;
        this.log = logAndReport;
        this.ss = screenshot;
        this.pageMethods = new AgCAPLocations_Page.AgCAPLocationsMethods();
    }

    public interface IAgCAPLocations {
        String pageName = "Agricultural CAP Locations";
        ...
        List lp_cspTerr_Textbox = Arrays.asList(By.id("ArLocationDetailHTML_ArLocInput_TerritoryCd_FLD"), pageName, "CSP Terr");
        List lp_construction_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocationDetailHTML_ArLocInput_ConstSymbolCd_LST_comboboxinput']"), pageName, "Construction");
        List lp_addCoverage_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocCovgsEdit_cboAddCoverage_comboboxinput']"), pageName, "Coverage DrpDwn");
        List lp_addCoverage_Button = Arrays.asList(By.id("ArLocCovgsEdit_dgLocCovgList_Row_AddNew"), pageName, "Add Coverage Button");
        List lp_BlanketGrpNo_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_BlktGrpNo_FLD"), pageName, "BlanketGrpNo");
        List lp_Coverage_Tab = Arrays.asList(By.xpath("//li[@title='Coverages']"), pageName, "Coverage Tab");
        List lp_Wind_Ded_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocationDetailHTML_OpLocInput_WindDedPct_LST_comboboxinput']"), pageName, "Wind % Ded");
        ...
        List lp_FldCvgType_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocFlodHTML_ArLocCovgInput_MiscTypeCd_LST_comboboxinput']"), pageName, "FldCvgType_DrpDwn");
        List lp_FldBldLimit_Textbox = Arrays.asList(By.id("ArLocFlodHTML_ArLocCovgInput_Limit2Amt_FLD"), pageName, "Flood Building Limit");
        //Building
        List lp_BldgBlanketGrpNo_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_BlktGrpNo_FLD"), "Location Coverages", "BlanketGrpNo");
        List lp_Limit_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_LimitAmt_FLD"), "Location Coverages", "Limit");
        List lp_Valuation_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_ValuationCd_LST_comboboxinput']"), "Location Coverages", "Valuation");
        List lp_DedFactor_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_DedOvrdFct_FLD"), "Location Coverages", "Ded Factor");
        List lp_IncreaseinRebuildingExpenses_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_IncRebuildPct_FLD"), "Location Coverages", "Increase in Rebuilding Expenses");
        List lp_MaximumAmountLimit_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_Limit2Amt_FLD"), "Location Coverages", "Maximum Amount Limit");
        List lp_RelatedExpensesLimit_Textbox = Arrays.asList(By.id("ArLocBldgHTML_ArLocCovgInput_Limit3Amt_FLD"), "Location Coverages", "Related Expenses Limit");
        List lp_BldgCovgType_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_CovgTypeCd_LST_comboboxinput']"), "Location Coverages", "Bldg Covg Type");
        List lp_MiscInd_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_MiscTypeCd_LST_comboboxinput']"), "Location Coverages", "Misc Ind");
        List lp_DeductibleOvrd_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_DedOvrdAmt_LST_comboboxinput']"), "Location Coverages", "Deductible Ovrd");
        List lp_AgreedValue_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_AgreedValInd_LST_comboboxinput']"), "Location Coverages", "Agreed Value");
        List lp_CoinsuranceOvrd_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_CoinsCd_LST_comboboxinput']"), "Location Coverages", "Coinsurance Ovrd");
        List lp_LimitationsOnRoofSurfacing_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_Misc1Tx_LST_comboboxinput']"), "Location Coverages", "Limitations on Roof Surfacing");
        List lp_IncrCostOfLossPercent_DrpDwn = Arrays.asList(By.xpath("//input[@id='ArLocBldgHTML_ArLocCovgInput_GrUpIncCostLossPct_LST_comboboxinput']"), "Location Coverages", "Incr Cost of Loss Percent:");
        //Earthquake
    ...
    public class AgCAPLocationsMethods implements AgCAPLocations_Page.IAgCAPLocations {

        public void addLocations(Map<String, List<String>> map) throws InterruptedException {
            if (map.get("AgCAPLocation_Flag").get(0).equalsIgnoreCase("Yes")) {
                baseUtil.navigatesToSpecifiedLinkOnPolicyExplorer("AG CAP Location");
                ...
                browserUtil.entersTextWithTabIn(gl_locationNo_textBox, map.get("LocationNoAgCAP").get(0));
                browserUtil.entersTextWithTabIn(gl_buildingNo_textBox, map.get("BuildingNoAgCAP").get(0));
    ...
    public AgCAPLocations_Page.AgCAPLocationsMethods theUser_() {
